...
loadSound("bg", "music/background.mp3");
const background = play("bg", {
    volume: 0.4,
    loop: true
})
loadSound("explosion", "music/explosion.wav");
loadSound("gameover", "music/gameover.wav");
loadSound("roar","music/roar.wav");
loadSound("laugh","music/laugh.wav");
// Here we are loading all our sprites at once before making any scenes or levels : 
loadSprite('bg', "assets/bg.jpg")
loadSprite("ground", "assets/ground.png")
loadSprite("player", "assets/player.jpeg");
loadSprite("player2", "assets/player_white.jpeg");
loadSprite("player3", "assets/player_blue.jpeg");
loadSprite("level1", "assets/level 1.png")
loadSprite("happyProfessor", "assets/happyProfessor.jpg")
loadSprite("door", "assets/door.jpeg")
loadSprite("door_white", "assets/door_white.jpeg");
loadSprite("vanita", "assets/vanita.png")
loadSprite("cow1", "assets/cow.jpg");
loadSprite("cow2", "assets/incomprehensible cow.png")
loadSprite("enemy1", "assets/enemy_black.jpeg");
loadSprite("enemy2", "assets/enemy.jpg")
loadSprite("happyProfessorBlue", 'assets/happyProfessorBlue.jpeg');
loadSprite('angryProfessorBlue', "assets/angryProfessorBlue.jpeg")
loadSprite('angryProfessorBlack', "assets/angryProfessorBlack.jpeg")
loadSprite("happyProfessorBlack","assets/happyProfessorBlack.jpeg");
// Game Summary : 
...
scene("gameover", () => {
    ...
    add([
        text("Press G to go back in the game. LEVEL 0"),
        pos(200, 400),
        scale(3)
    ])
    add([
...
// Come on. said Betsy We have to pick up this cornn. We don't have another can of popcorn.
scene("gameLevel1", () => {
    let right;
    ...
    let correctWords = `Come on. said Betsy We have to pick up this cornn. We don't have another can of popcorn.`;
